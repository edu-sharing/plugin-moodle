...
/**
 * ATTENTION: because of php's missing namespaces the class "Repository" as 
 * provided by Alfresco(tm) had to be renamed to "AlfrescoRepository".
 *
 */
class AlfrescoRepository extends BaseObject
{
