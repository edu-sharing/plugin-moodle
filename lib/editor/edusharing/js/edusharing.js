...
edusharingObject.prototype.link = function link(node, editor, moodle_wwwroot) {
    // helper-url
    var helper_url = moodle_wwwroot + '/lib/editor/edusharing/helpers/insert.php';
        ...
        on: {
            ...
            success: function(transId, o, args) {
                try
                {
                    ...
                    alert('Invalid server-data received.');
                    return false;
                }

                // import received data
                if ( ! data.id ) {
                    alert('No resource-id found in data.');
                    return false;
                }
            ...
            failure: function(transId, o, args) {
                ...
                alert('A server-side error occured while linking the object.');
                return false;
            }
        }
    };
...
edusharingObject.prototype.update = function update(node, editor, moodle_wwwroot) {
    ...
    var helper_url = moodle_wwwroot + '/lib/editor/edusharing/helpers/update.php';
    ...
    var config = {
        ...
        on: {
            ...
            failure: function(transId, o, args) {
                alert('An error occured while updating object "' + object.id + '".');
                return false;
            }
        }
    };
...
edusharingObject.prototype.unlink = function unlink(node, editor, moodle_wwwroot) {
    ...
    var helper_url = moodle_wwwroot + '/lib/editor/edusharing/helpers/delete.php';
    ...
    var config = {
        ...
        on: {
            ...
            failure: function(transId, o, args) {
                alert('An error occured while deleting object "' + object.id + '".');
                return false;
            }
        }
    };
