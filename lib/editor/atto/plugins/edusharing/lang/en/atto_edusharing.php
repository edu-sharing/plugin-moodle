...
$string['hint'] = 'Select an edu-sharing object from the repository to embed it in Moodle. Click on "'.$string['openRepo'].'". Search for the desired object and click the "APPLY" button.';
