...
$string['createedusharing'] = 'Create edusharing';
$string['pluginname'] = 'edusharing (Atto)';
$string['settings'] = 'edusharing (Atto)';
$string['browse'] = 'Browse';
$string['visible'] = 'Visible';
$string['nothingtoinsert'] = 'Nothing to insert!';
$string['dialogtitle'] = 'Insert edu-sharing material';
$string['insert'] = 'Insert';
$string['cancel'] = 'Cancel';
$string['enterflavor'] = 'Enter Ice Cream Flavor';
$string['defaultflavor'] = 'Default Ice Cream Flavor';
$string['edusharing:visible'] = 'Visible';
