...
$string['hint'] = 'Wählen Sie ein edu-sharing Objekt aus dem Repositorium um es im Kurs anzuzeigen. Klicken Sie dazu auf den Button und anschließend auf bla..';
$string['skipHint'] = 'Beim nächsten mal direkt zur Suche springen';
$string['openRepo'] = 'Repo öffnen';
$string['directoryHint'] = 'Der Ordner wird eingebunden. Elemente werden angezeigt, nicht aber weitere Unterordner.';
