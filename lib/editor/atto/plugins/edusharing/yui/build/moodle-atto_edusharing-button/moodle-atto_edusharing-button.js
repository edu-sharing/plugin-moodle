...
// along with Moodle.  If not, see <http://www.gnu.org/licenses/>.
    ...
    */
    ...
    var TEMPLATE = '' +
        ...
        '<button onclick="window.win = window.open(\'http://localhost:8080/edu-sharing/components/search?reurl=WINDOW\');">open repo</button>'+
        ...
        '<input id="edusharing_node_id" name="edusharing_node_id" value="" />' +
    ...
    Y.namespace('M.atto_edusharing').Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
        ...
        _getFormContent: function(clickedicon) {
            var template = Y.Handlebars.compile(TEMPLATE),
                content = Y.Node.create(template({
                    ...
                    edusharing_hint_hide: Y.Cookie.get("edusharing_hint_hide")
                }));
        ...
        edusharing_hint_check_change: function() {
