...
// along with Moodle.  If not, see <http://www.gnu.org/licenses/>.
    ...
    var TEMPLATE = ' \
        ...
        <form id="edusharing_form" class="atto_form" style="display: none"> \
            ...
            Der Ordner wird eingebunden. Elemente werden angezeigt, nicht aber weitere Unterordner.\
            </div>\
            <!--<div id="edusharing_wrapper_subtitle" class="edusharing_form_wrapper"> \
                ...
                <label for="edusharing_version_latest" class="edusharing_label_inline" id="edusharing_version_latest_label"> Immer letzte Version anzeigen</label> \
            ...
            while (0 < nodes.length) {
                ...
                if (1 == node.nodeType) {
                    ...
                    if (node.getAttribute('es:object_url')) {
                        ...
                        if (existingObjects[resource_id]) {
                            // save object
                            var object = existingObjects[resource_id];
                            ...
                            // remove from list
                            delete existingObjects[resource_id];
                        } else {
    ...
    edusharingObject.prototype.link = function link(node) {
        ...
        var helper_url = M.cfg.wwwroot + '/lib/editor/edusharing/helpers/insert.php?sesskey=' + M.cfg.sesskey;
    ...
    edusharingObject.prototype.update = function update(node) {
        ...
        var helper_url = M.cfg.wwwroot + '/lib/editor/edusharing/helpers/update.php?sesskey=' + M.cfg.sesskey;
    ...
    edusharingObject.prototype.unlink = function unlink(node) {
        ...
        var helper_url = M.cfg.wwwroot + '/lib/editor/edusharing/helpers/delete.php?sesskey=' + M.cfg.sesskey;
