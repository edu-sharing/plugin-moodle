...
// along with Moodle.  If not, see <http://www.gnu.org/licenses/>.
    ...
    var TEMPLATE = ' \
        ...
        <form id="edusharing_form" class="atto_form" style="display: none"> \
            ...
            <!--<div id="edusharing_wrapper_subtitle" class="edusharing_form_wrapper"> \
                ...
                <label for="edusharing_version_latest" class="edusharing_label_inline"> Immer letzte Version anzeigen</label> \
    ...
    Y.namespace('M.atto_edusharing').Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
        ...
        open_repo: function() {
            var url = this.get('repourl') + '/components/search?reurl=WINDOW&ticket=' + this.get('ticket');
